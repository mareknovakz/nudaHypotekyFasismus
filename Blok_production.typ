...
#let poem-poetry(title, body_content) = [
  ...
  #set par(first-line-indent: 0pt, justify: true, leading: 10pt, spacing: 10pt)
...
#page(footer: none, margin: 1.5cm)[
  ...
  #v(1fr)
  #text(size: 10pt, font: "Courier Prime")[Nakladatelství PVL]
  \
  #text(size: 10pt, font: "Courier Prime")[Praha 2026]
  #v(15%)
]
#blank-page()
#page(footer: none)[
